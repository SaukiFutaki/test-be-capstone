...
export function DataTableFacetedFilter<TData, TValue>({
  ...
  const handleSelect = React.useCallback((optionValue: string) => {
    ...
    // Set filter value - empty array means no filter
              ...
              {options.map((option) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <CheckIcon className={cn("h-4 w-4 text-green-500")} />
                    </div>
                    {option.icon && (
